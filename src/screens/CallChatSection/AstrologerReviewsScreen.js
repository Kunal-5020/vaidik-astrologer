...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#121212' }, // Dark theme for Astrologer
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 50 },
  header: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    padding: 20, backgroundColor: '#1E1E1E', borderBottomWidth: 1, borderBottomColor: '#333'
  },
  ...
  ratingBadge: {
    ...
    backgroundColor: '#4CAF50', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8
  },
  ratingText: { color: '#FFF', fontWeight: 'bold', fontSize: 14 },
  reviewText: { color: '#DDD', fontSize: 14, lineHeight: 20, marginBottom: 10 },
  noText: { color: '#666', fontSize: 13, fontStyle: 'italic', marginBottom: 10 },
  cardFooter: { flexDirection: 'row', alignItems: 'center', gap: 6, borderTopWidth: 1, borderTopColor: '#333', paddingTop: 8 },
  serviceType: { color: '#888', fontSize: 12 },
